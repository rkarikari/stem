...
def initialize_ui():
	...
	if A in st.session_state and _E not in st.session_state.api_keys:st.session_state.api_keys[_E]='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'
