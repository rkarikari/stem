...
import base64
st.set_page_config(page_title=' Tactical Analysis ',page_icon='🏆',layout='wide',initial_sidebar_state='expanded',menu_items={'Report a Bug':'https://github.com/rkarikari/stem','About':'Copyright © RNK, 2025 RadioSport. All rights reserved.'})
...
if _AM not in st.session_state:st.session_state.ai_analysis=_w
...
def create_pdf_export(formation,lineup,stats,ai_analysis=_w,rankings=_w):
	...
	if g:
		A.append(PageBreak());A.append(Paragraph('Formation Power Rankings',F));A.append(Spacer(1,.2*inch));l=[['Rank','Formation','Score','Avg Rating','Attack','Defense']]
